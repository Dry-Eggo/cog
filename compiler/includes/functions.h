...
FunctionInfo* func_info_new(Span span, const char* name, const char* linkage_name, const char* mangled_name, bool variadic, JVec param_info, TypeInfo* type);
size_t        func_info_get_arity(FunctionInfo* finfo);
const char*   func_info_get_mname(FunctionInfo* finfo);
